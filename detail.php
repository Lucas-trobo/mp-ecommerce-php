...
$preference->back_urls = array(
    "success" => "https://lucas-trobo-mp-commerce-php.herokuapp.com/checkout.php?status=success",
    "failure" => "https://lucas-trobo-mp-commerce-php.herokuapp.com/checkout.php?status=failure",
    "pending" => "https://lucas-trobo-mp-commerce-php.herokuapp.com/checkout.php?status=pending"
);
...
$item->picture_url = 'https://lucas-trobo-mp-commerce-php.herokuapp.com/'.substr($_POST['img'], 2);
$item->title = $_POST['title'];
$item->quantity = $_POST['unit'];
$item->unit_price = $_POST['price'];
$preference->items = array($item);
$preference->notification_url = 'https://lucas-trobo-mp-commerce-php.herokuapp.com/ipn.php';
$preference->external_reference = "lucastrobo@gmail.com";
                        ...
                        <div class="as-accessories-results  as-search-desktop">
                            <div class="width:60%">
                                ...
                                <div class="as-producttile-info" style="float:left;min-height: 168px;">
                                    ...
                                    <a href="<?php echo $preference->init_point; ?>"> Pagar compra</a>
